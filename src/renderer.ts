...
function _curveWithOffset(points: Point[], offset: number, o: ResolvedOptions): Op[] {
    const ps: Point[] = [];
    ps.push([
        points[0][0] + _offsetOpt(offset, o) + o.translation[0],
        points[0][1] + _offsetOpt(offset, o) + o.translation[1],
    ]);
    ps.push([
        points[0][0] + _offsetOpt(offset, o) + o.translation[0],
        points[0][1] + _offsetOpt(offset, o) + o.translation[1],
    ...
    for (let i = 1; i < points.length; i++) {
        ps.push([
            points[i][0] + _offsetOpt(offset, o) + o.translation[0],
            points[i][1] + _offsetOpt(offset, o) + o.translation[1],
        ]);
